...
class RecievedScreen extends Component{
    constructor(props){
        super(props);  
        this.state={
            idshipper:'',
    ...
    onOrder = () =>{
        if(this.state.idshipper !== ''){
            let thamso = new FormData();
            thamso.append("trangthai", 3);
            thamso.append("condition", 4);
    ...
    render(){
        ...
        return(
            <SafeAreaView style={{backgroundColor: '#F5D0A9', height: '99%'}}>
