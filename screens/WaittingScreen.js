...
import { View, Text, Image, SafeAreaView, Button,StyleSheet,ScrollView, Alert } from "react-native";
...
class OrderScreen extends Component{
    ...
    onOrder = (text) =>{
        ...
        thamso.append("trangthai", 1);
        thamso.append("condition", text);
        ...
        return(
            <SafeAreaView style={{height:'99%'}}>
                <TouchableOpacity onPress={this.onOrder}>
                    <Text style={styles.text}>Đơn hàng đang chờ xác nhận</Text>  
                </TouchableOpacity>
                <View style={styles.picker}>
                                <Picker 
                                    onPress={this.onClick}
                                    style= {{width: '40%', backgroundColor:'#98fb98', borderColor:'#000000', marginRight: 10}}
                                    selectedValue={this.state.PickerValue} 
                                    onValueChange={this.onValueChange}
                                >
                                    <Picker.Item label="Tất cả" value="all" />
                                    <Picker.Item label="Ninh Kiều" value="ninhkieu" />  
                                    <Picker.Item label="Cái Răng" value="cairang" />  
                                    <Picker.Item label="Bình Thủy" value="binhthuy" />
                                    <Picker.Item label="Ô Môn" value="omon" />
                                    <Picker.Item label="Thốt Nốt" value="thotnot" />       
                                </Picker>
                            </View>
                <ScrollView>
                    {
                        ...
                        this.state.order.map((data, index) =>{
                            return(
                                <View style={styles.container} key={index}>
                                    ...
                                    <Button title="Nhận đơn" onPress={this.Submit.bind(this,data.iddh, data.trangthai)}/>
                                </View>
                            )
                         }     
                    )
